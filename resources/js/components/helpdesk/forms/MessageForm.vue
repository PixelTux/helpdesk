    ...
    <div class="border-t border-gray-200 p-4">
        <div class="mb-2 flex items-center space-x-2">
            <Button
                ...
                variant="outline"
                class="text-xs"
                :class="{ 'border-amber-200 bg-amber-100 hover:bg-amber-100': messageType === 'internal' }"
            ...
            <Button
                ...
                variant="outline"
                class="text-xs"
                :class="{ 'border-zinc-300 bg-zinc-50': messageType === 'agent' }"
...
async function submitMessage() {
    ...
    try {
        ...
        router.post(
            `/helpdesk/${props.conversationId}/messages`,
            {
