<template>
    <AppLayout>
        <div class="flex h-full">
            ...
            <div class="flex h-full w-80 flex-col overflow-hidden border-r border-gray-200">
                ...
                <div v-if="!filterCollapsed" class="shrink-0 border-b border-gray-200">
                    <ConversationFilter
                        :currentFilters="{}"
                        :filterOptions="{
                            statuses: [],
                            priorities: [],
                            stats: { total: conversations.data.length, unread: 0, by_status: {}, by_priority: {} },
                        }"
                ...
                <div class="flex-1 overflow-y-auto">
                    <div v-if="conversations.data.length === 0" class="p-4 text-center text-gray-500">No conversations yet</div>
                    <div v-else>
                        ...
                        <div v-if="hasMorePages" ref="loadTrigger" class="flex items-center justify-center p-4">
                            ...
                            <div v-else class="text-xs text-gray-400">Scroll to load more...</div>
                        </div>
                        <div v-else-if="conversations.data.length > 0" class="py-6 text-center text-gray-600">You've reached the end!</div>
                    </div>
                </div>
            </div>
            ...
            <div class="h-full flex-1 overflow-hidden">
                <div v-if="!activeConversation" class="flex h-full items-center justify-center text-gray-500">
...
const handleStatusChanged = (data: { status: string; conversation_id: string }) => {
...
const handlePriorityChanged = (data: { priority: string; conversation_id: string }) => {
