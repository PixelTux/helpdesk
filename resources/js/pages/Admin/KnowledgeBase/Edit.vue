        ...
        <div class="rounded-lg border shadow-sm">
            <form @submit.prevent="submitForm" class="space-y-6 p-6">
                ...
                <div>
                    ...
                    <Input id="title" v-model="form.title" placeholder="Enter article title" :class="{ 'border-red-300': errors.title }" />
                    ...
                    <div class="flex items-center space-x-4">
                        <label class="flex items-center">
                            <input
                                ...
                                class="h-4 w-4 rounded border-muted-foreground text-blue-600 focus:ring-blue-500"
                            />
...
const form = reactive({
    ...
    published_at: props.article.published_at ? new Date(props.article.published_at).toISOString().slice(0, 16) : '',
});
